...
export class ReceiptFormEditComponent implements OnInit {
  ...
  receipt: {
    ...
    from?: string,
    billTo?: { firstname?: string, lastname?: string, address1?: string, address2?: string, city?: string, country?: string, CreatedByUser: string, ModifiedByUser: string},
    receiptLines?: { quantity: number, price: number, product: { name: string, number?: string, description?: string }
    }[],
    endNotes?: string,
    Number: string,
    ...
    ModifiedByUser: string, 
      ...
      Number: "RCTPTJJDJD0101",
      CreatedByUser: 'dgumbo',
      ...
      , billTo: { CreatedByUser: 'dgumbo', ModifiedByUser: 'dgumbo' },
    };
